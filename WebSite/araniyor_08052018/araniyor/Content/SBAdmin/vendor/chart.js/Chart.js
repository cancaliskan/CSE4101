 ...
 * https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/blob/master/LICENSE.md
 */
		...
		update: function(reset) {
			...
			if (showLine) {
				...
				line._model = {
					...
					// to https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/2435#issuecomment-216718158
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			...
			if (!context || !canvas) {
				...
				// https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/2807
		...
		*/
		...
		render: function(config) {
			...
			if (animationOptions && ((typeof duration !== 'undefined' && duration !== 0) || (typeof duration === 'undefined' && animationOptions.duration !== 0))) {
				...
				// See https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/3781
		...
		bindEvents: function() {
			...
			// See https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/2210
			if (me.options.responsive) {
				listener = function() {
					me.resize();
				};
...
module.exports = function(Chart) {
	...
	helpers.retinaScale = function(chart, forceRatio) {
		...
		// See https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/3575
 ...
 * @see https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/pull/4591#issuecomment-319575939
 */
...
function initCanvas(canvas, config) {
	...
	// https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/2538
...
// https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/4287
...
module.exports = {
	...
	acquireContext: function(item, config) {
		...
		// https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/3887
		// https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/4102
		// https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/4152
 ...
 * @see https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/2380#issuecomment-279961569
 * @see https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/issues/2440#issuecomment-256461897
 */
...
module.exports = function(Chart) {
	...
	var defaultConfig = {
		 ...
		 * @see https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/pull/4507
		 * @since 2.7.0
		 */
		distribution: 'linear',
		 ...
		 * @see https://github.com/chart~/Content/SBAdmin/js/Chart.~/Content/SBAdmin/js/pull/4556
		 * @since 2.7.0
		 */
		bounds: 'data',
