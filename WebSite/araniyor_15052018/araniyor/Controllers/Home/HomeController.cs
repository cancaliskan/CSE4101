...
namespace araniyor.Controllers.Home
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.solMenuMesajlar = db.messages.ToList();
        ...
        public ActionResult Mesajlasma(int? receiverID)
        {
            ...
            if (receiverID !=null)
            {
                var tempMesajList = db.messages.Where(x => x.senderID == receiverID && x.receiverID == senderID && x.isRead == false).ToList();
                foreach (var item in tempMesajList)
                {
                    item.isRead = true;
